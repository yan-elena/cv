...
% \definecolor{SwishLineColour}{HTML}{172A41}
% \definecolor{MarkerColour}{HTML}{172A41}
...
\leftheader{%
  {\LARGE\bfseries\sffamily Elena Yan}

  \makefield{\faEnvelope[regular]}{\href{mailto:elena.yan@studio.unibo.it}{\texttt{elena.yan@studio.unibo.it}}}
  \makefield{\faEnvelope[regular]}{\href{mailto:yanelena0220@gmail.com}{\texttt{yanelena0220@gmail.com}}}
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  
  \makefield{\faGithub}{\url{https://github.com/yan-elena}}

  \makefield{\faUser}{Birth date: 20/02/1999}
  \makefield{\faMapPin[regular]}{Forlì, Italy}
...
\makerubric{cv-parts/education}
\makerubric{cv-parts/employment}
\makerubric{cv-parts/skills}
\makerubric{cv-parts/portfolio}
\makerubric{cv-parts/misc}

% \makerubric{cv-parts/referee}
% \input{cv-parts/referee-full}
